 ...
 */
public class ShortFilm extends Fragment {
    ...
    private RecyclerView shortFilmRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_short_film, container, false);
        shortFilmRecyclerView=rootView.findViewById(R.id.shortFilmRecyclerView);

        warningText=rootView.findViewById(R.id.warning);
        source=new MovieDatabaseSource(getContext());
        movieList=source.getSelectedTypeMovies("Short Film");
        if (movieList.size()==0){
            ...
            shortFilmRecyclerView.setLayoutManager(llm);
            shortFilmRecyclerView.setAdapter(movieListAdapter);
        }
