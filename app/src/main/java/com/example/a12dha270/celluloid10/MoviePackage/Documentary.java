 ...
 */
public class Documentary extends Fragment {
    ...
    private RecyclerView documentaryRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_documentary, container, false);
        documentaryRecyclerView=rootView.findViewById(R.id.documentaryRecyclerView);

        warningText=rootView.findViewById(R.id.warning);
        source=new MovieDatabaseSource(getContext());
        movieList=source.getSelectedTypeMovies("Documentary");
        if (movieList.size()==0){
            ...
            documentaryRecyclerView.setLayoutManager(llm);
            documentaryRecyclerView.setAdapter(movieListAdapter);
        }
